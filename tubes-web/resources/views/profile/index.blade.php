...
<div class="max-w-6xl mx-auto px-4">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900 mb-2">
            <i class="fas fa-user-circle text-purple-600"></i> My Profile
        </h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-lg p-6 sticky top-20" x-data="{ activeTab: 'profile' }">
                <!-- Profile Card -->
        ...
        <div class="lg:col-span-2" x-data="{ activeTab: 'profile' }">
            ...
            <div x-show="activeTab === 'password'" x-transition class="bg-white rounded-xl shadow-lg p-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">
                    <i class="fas fa-key text-purple-600"></i> Change Password
                </h2>
            ...
            <div x-show="activeTab === 'history'" x-transition class="bg-white rounded-xl shadow-lg p-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">
                        <i class="fas fa-shopping-bag text-purple-600"></i> Purchase History
                    </h2>
