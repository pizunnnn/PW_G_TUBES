    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">
                <i class="fas fa-plus-circle text-purple-600"></i> Tambah Slider Baru
            </h1>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-image text-purple-600"></i> Gambar Slider <span class="text-red-500">*</span>
                        </label>
                        <input
                            type="file"
                            name="image"
                            ...
                            required
                        >
                        <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, WEBP. Max: 2MB. Rekomendasi ukuran: 1920x600px</p>
                        @error('image')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
