...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="{{ route('admin.products.index') }}" class="bg-blue-100 p-6 rounded-lg text-center hover:bg-blue-200 transition">
            <i class="fas fa-box text-4xl text-blue-600 mb-2"></i>
            <p class="font-semibold text-gray-800">Manage Products</p>
        </a>
        <a href="{{ route('admin.transactions.index') }}" class="bg-yellow-100 p-6 rounded-lg text-center hover:bg-yellow-200 transition">
            <i class="fas fa-receipt text-4xl text-yellow-600 mb-2"></i>
            <p class="font-semibold text-gray-800">Transactions</p>
        </a>
        <a href="{{ route('admin.users.index') }}" class="bg-purple-100 p-6 rounded-lg text-center hover:bg-purple-200 transition">
