    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">
                <i class="fas fa-edit text-purple-600"></i> Edit Produk
            </h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" x-data="{
                hasDiscount: {{ old('discount_type', $product->discount_type) ? 'true' : 'false' }},
                discountType: '{{ old('discount_type', $product->discount_type ?? 'percentage') }}',
                ...
                <div class="mb-6">
                    ...
                    <div class="flex gap-4 mb-4">
                        ...
                        <label class="flex items-center">
                            ...
                            >
                            <span class="ml-2 text-sm font-medium text-gray-700">Upload New File</span>
                        </label>
                    </div>
                    ...
                    <div id="file-input" class="hidden">
                        ...
                        >
                        <p class="text-sm text-gray-500 mt-1">Upload new image file (JPG, PNG, max 2MB)</p>
